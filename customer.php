...
{
    $data = getPosts();
    $update_Query = "UPDATE `customer` SET `cname`='$data[0]',`sid`='$data[2]',`cphone`='$data[3]' WHERE `cust_id` = '$data[1]'";
    try{
...
<html>
    ...
    <center>
        ...
        <form action="customer.php" method="post">
            <div class="input">
            <input type="text" name="cust_id" placeholder="cust_id" value="<?php echo $cust_id;?>"><br></br>
            ...
            <input type="number" name="cphone" placeholder="cphone" value="<?php echo $cphone;?>"><br></br>
            </div>
            <br>
            <div class="col-sm-6">
