...
<br><br>
    ...
    <center>
        ...
        <div class="input_box">
            <input type="text" name="track_id" placeholder="track_id" value="<?php echo $track_id;?>"><br></br>
            <input type="text" name="sid" placeholder="shop id" value="<?php echo $sid;?>"><br></br>
            <input type="text" name="arr_time" placeholder="timming" value="<?php echo $arr_time;?>"><br></br>
