...
{
    $data = getPosts();
    $update_Query = "UPDATE `shop` SET `sname`='$data[1]',`sfloor`='$data[2]',`sservice`='$data[3]',`did`='$data[4]'  WHERE `sid` = '$data[0]'";
    try{
...
<br><br>
    ...
    <center>
        ...
        <div class="input">
            ...
            <input type="text" name="sfloor" placeholder="floorname" value="<?php echo $sfloor;?>"><br></br>
