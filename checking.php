...
<center>
        <form action="checking.php" method="post">
            <div class="input_box">
            <input type="text" name="eid" placeholder="eid" value="<?php echo $eid;?>"><br></br>
            <input type="text" name="ch_no" placeholder="ch_no" value="<?php echo $ch_no;?>"><br></br>
            <input type="number" name="temp" placeholder="temperature" value="<?php echo $temp;?>"><br></br>
