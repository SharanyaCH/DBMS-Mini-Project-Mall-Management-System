...
<html>
    ...
    <centre>
        <form action="owner.php" method="post">
            <input type="number" name="tras_id" placeholder="tras_id" value="<?php echo $tras_id;?>"><br></br>
            <input type="number" name="sid" placeholder="shop id" value="<?php echo $sid;?>"><br></br>
            <input type="number" name="rent_amt" placeholder="rent_amt" value="<?php echo $rent_amt;?>"><br></br>
            <input type="number" name="date" placeholder="date" value="<?php echo $date;?>"><br></br>
